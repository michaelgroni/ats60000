...
DE = {
    ...
    "err_invalid_memory_values": "Ungültige Werte im Empfängerstatus – Speichern abgelehnt",
...
EN = {
    ...
    "err_invalid_memory_values": "Invalid values in receiver status – save rejected",
